...
{
	Fixed result;
	result.fixedPointValue = (this->fixedPointValue * fixed.fixedPointValue) >> this->fractionalBitsVal;
	return (result);
}
...
{
	Fixed result;
	result.fixedPointValue = (this->fixedPointValue << this->fractionalBitsVal) / fixed.fixedPointValue;
	return (result);
}
...
{
	if (this->fixedPointValue > to_cmp.fixedPointValue)
		return (true);
	else
		return (false);
}
